...
public class AppTest {
    ...
    void testUpDatePersonById() throws Exception {
        ...
        MockHttpServletResponse response1 = mockMvc
                .perform(patch("/people/4")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"firstName\": \"Leonel\", \"lastName\": \"Messi\"}")
                )
                .andReturn()
                .getResponse();
        ...
        assertThat(response2.getContentAsString()).contains("Leonel", "Messi");
        assertThat(response2.getContentAsString()).doesNotContain("Robert", "Lock");
    }
